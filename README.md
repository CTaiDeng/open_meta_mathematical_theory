...
[![DOI](script\zenodo.20172851.svg)](https://zenodo.org/records/20172851)
# Citation
#### Gao, Z. (2026). Meta-Mathematical Theory based on Pan-Logic Analysis and Pan-Iterative Analysis (GaoZheng G-Framework) and the Principal-Bundle-Based Generalized Noncommutative Lie Algebra (GaoZheng G-Algebra) 中文工作笔记 (v4.0). Zenodo. https://doi.org/10.5281/zenodo.20172851
